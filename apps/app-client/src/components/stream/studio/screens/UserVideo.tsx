...
import { Mic, MicOff, User, Video as VideoIcon, VideoOff, Plus, Minus } from 'lucide-react';
...
const UserVideo = (props: Props) => {
    ...
    return (
        <div className="aspect-video bg-secondary h-36 relative rounded-md overflow-hidden group cursor-pointer">
